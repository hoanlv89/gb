...
struct  NormalizationCheck_t2063728339 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(NormalizationCheck_t2063728339, ___value___1)); }
