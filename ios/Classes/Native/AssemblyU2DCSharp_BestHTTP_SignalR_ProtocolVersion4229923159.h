...
struct  ProtocolVersions_t4229923159 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ProtocolVersions_t4229923159, ___value___1)); }
