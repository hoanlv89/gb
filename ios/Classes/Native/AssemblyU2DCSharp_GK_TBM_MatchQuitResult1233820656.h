...
struct  GK_TBM_MatchQuitResult_t1233820656  : public ISN_Result_t2775631610
{
public:
...
public:
	inline static int32_t get_offset_of__MatchId_2() { return static_cast<int32_t>(offsetof(GK_TBM_MatchQuitResult_t1233820656, ____MatchId_2)); }
