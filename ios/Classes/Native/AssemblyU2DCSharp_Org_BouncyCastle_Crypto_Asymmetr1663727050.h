...
struct  AsymmetricKeyParameter_t1663727050  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_privateKey_0() { return static_cast<int32_t>(offsetof(AsymmetricKeyParameter_t1663727050, ___privateKey_0)); }
