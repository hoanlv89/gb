...
struct  GK_TBM_RematchResult_t3159773700  : public ISN_Result_t2775631610
{
public:
...
public:
	inline static int32_t get_offset_of__Match_2() { return static_cast<int32_t>(offsetof(GK_TBM_RematchResult_t3159773700, ____Match_2)); }
