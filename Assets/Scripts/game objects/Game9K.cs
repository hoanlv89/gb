...
public class Game9K : Game, IPokerGameLiked, IAutoReadyGame
{
	public Vector2[]  StaticPos9 {
		get {
			...
			return new Vector2[]{
				...
				new Vector2 (290, -210*y/720),//8
				new Vector2 (510, -110*y/720),//7
				new Vector2 (510, 120*y/720),//6
				new Vector2 (300, 265*y/720),//5
				new Vector2 (-300, 265*y/720),//4
				new Vector2 (-510, 120*y/720),//3
				new Vector2 (-510, -110*y/720),//2
				new Vector2 (-290, -210*y/720)//1
			};
		}
	}
