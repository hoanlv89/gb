    ...
    public class ServerName
    {
        ...
        public virtual void Encode(Stream output)
        {
            ...
            case Tls.NameType.host_name:
				byte[] utf8Encoding = Org.BouncyCastle.Utilities.Strings.ToUtf8ByteArray((string)mName);
        ...
        public static ServerName Parse(Stream input)
        {
            ...
            case Tls.NameType.host_name:
            {
                ...
                if (utf8Encoding.Length < 1)
					...
					name = Org.BouncyCastle.Utilities.Strings.FromUtf8ByteArray(utf8Encoding);
                break;
            }
            default:
                throw new TlsFatalAlert(AlertDescription.decode_error);
